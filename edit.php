...
$input = mysqli_fetch_assoc($query);
...
<body>
    ...
    <div class="floating-form-container">
        ...
        <form method="POST" action="update.php" enctype="multipart/form-data">
            ...
            <input type="text" name="merk" required value="<?php echo $input['merk'] ?>"><br>

            <label for="tipe">tipe sepeda motor</label>
            <select name="tipe" value="<?php echo $input['tipe'] ?>">
                <option value="" disabled selected>--pilih tipe sepeda motor--</option>
                <option value="sport" <?php echo ($input['tipe'] == 'sport') ? 'selected' : ''; ?>>Sport</option>
                <option value="cruiser" <?php echo ($input['tipe'] == 'cruiser') ? 'selected' : ''; ?>>cruiser</option>
                <option value="touring" <?php echo ($input['tipe'] == 'touring') ? 'selected' : ''; ?>>touring</option>
                <option value="naked" <?php echo ($input['tipe'] == 'naked') ? 'selected' : ''; ?>>naked</option>
            </select>

            <label for="harga">harga</label>
            <input type="number" name="harga" required value="<?php echo $input['harga'] ?>"><br>

            <label for="jumlah">jumlah</label>
            <input type="number" name="jumlah" required value="<?php echo $input['jumlah'] ?>"><br>
